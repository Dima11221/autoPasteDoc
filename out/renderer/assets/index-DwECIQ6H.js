...
const App = () => {
  ...
  const [photosFolder, setPhotosFolder] = reactExports.useState(null);
  const [status, setStatus] = reactExports.useState("Выберите документ и папку с фото.");
  const [busy, setBusy] = reactExports.useState(false);
  const [lastOutputPath, setLastOutputPath] = reactExports.useState(null);
  const [isError, setIsError] = reactExports.useState(false);
  const docxLabel = reactExports.useMemo(
    () => docxPath ? fileNameFromPath(docxPath) : "Файл не выбран",
    [docxPath]
  );
  const folderLabel = reactExports.useMemo(
...
Файл: ${fileNameFromPath(result.outputPath)}${skippedText}`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { style: { fontFamily: "system-ui", padding: 24, maxWidth: 720 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Вставка фото в Word." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Для работы с отчетами. Работает с помощью нумерации в именах фото." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gap: 12, marginTop: 24 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onSelectDocx, disabled: busy, children: "1. Выбрать Word-файл (.docx)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { title: docxPath ?? void 0, style: { whiteSpace: "pre-wrap" }, children: docxLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onSelectPhotos, disabled: busy, children: "2. Выбрать папку с фото" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "code",
        {
          title: photosFolder ?? void 0,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: busy ? "Вставляю..." : "3. Вставить фото"
        }
      ),
      busy && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            "aria-hidden": true,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Обработка документа, подождите..." })
      ] }),
      lastOutputPath && !busy && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onReveal, children: "Показать результат в Finder / Проводнике" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "pre",
      {
